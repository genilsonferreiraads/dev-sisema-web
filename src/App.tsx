      ...
      <footer className="relative py-6 border-t border-[#404040] bg-[#1e1e1e] shadow-lg">
        <div className="container mx-auto px-4 relative">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-center">
            ...
            <div className="flex flex-col items-center md:items-start gap-3 md:pl-8">
              ...
              <span className="flex items-center gap-2 text-gray-400 text-sm group cursor-pointer">
                <svg className="w-4 h-4 transition-colors duration-300 group-hover:text-[#e1aa1e]" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z"/>
                </svg>
                <span className="group-hover:text-[#e1aa1e] transition-colors duration-300">
                  Av. Nilo Coelho, n° 139, Cabrobó - PE, 56180-000
                </span>
              </span>
            </div>
            ...
            <div className="flex flex-col items-center md:items-center gap-4 md:pr-8">
              <h3 className="text-[#e1aa1e] font-bold text-lg relative group cursor-default">
                Nossas Redes Sociais
                <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-[#e1aa1e] group-hover:w-full transition-all duration-300"></span>
              </h3>
              <div className="flex items-center gap-6">
                ...
                >
                  <div className="absolute -inset-2 bg-gradient-to-r from-[#e1aa1e] to-[#f5d485] rounded-lg opacity-0 group-hover:opacity-20 transition-all duration-300 blur"></div>
                  <svg 
                    className="w-7 h-7 text-gray-400 group-hover:text-[#e1aa1e] transition-all duration-300 transform group-hover:scale-110 relative z-10" 
                    fill="currentColor" 
                    viewBox="0 0 24 24"
                  >
